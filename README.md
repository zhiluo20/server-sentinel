# ServerSentinel website

Static product, privacy, and support pages for ServerSentinel. The site uses no JavaScript, cookies, analytics, tracking, or third-party assets.
